...
const Menpage = () => {
    ...
    return (
        <div>
            ...
            <Text fontSize="2xl" lineHeight="25px" textAlign="center">ONE OF A KIND</Text>
            <Link href='#' textDecoration="underline" fontSize='14px' color="#333333" ml={"50%"} >VIEW ALL</Link>
            <br />
            <br />
