...
import OneOfAKind from "./Slider/OneofaKind";
  ...
  return (
    ...
    <BlackNav/>
      <div className="top">
        <div>
          <img
            src="https://www.yoox.com/images/yoox80/banners/6895_1_Genz_WM_Main.png?634485886601286852#width=1380&height=637"
            alt=""
          />
        </div>
      </div>
      ...
      <div className="buyMore_mainDiv">
        ...
        <div className="designers">
          <br />
          <p>
            <span className="desi1">DESIGNERS</span>
          </p>
          <br />
          <p className="designer_hover">
            <a href="">ROBERTO CAVALI</a>
          </p>
          <p className="designer_hover">
            <a href="">DSQUARED2</a>
          </p>
          ...
          <p className="designer_hover">
            <a href="">
              <span className="desi">VIEW ALL</span>
            </a>
          </p>
        </div>
        ...
        <div>
          ...
          <div className="buyMore_until">
            Futuristic fashion: the beginning of a new era!
          </div>
          <div className="buyMore_shop">
            DISCOVER MORE <div className="buyMore_shop1">ESHOP NOW</div>{" "}
          </div>
        </div>
      </div>
      ...
      <div className="watchMainBanner">
        <div className="watchBanner">
          <img
            src="https://www.yoox.com/images/yoox80/banners/6825_5_BaumeMercier_Tris_W.png?634485886601286852#width=473&height=660"
            alt=""
          />
          <br />
        ...
        <div className="girlBag">
          <img
            src="https://www.yoox.com/images/yoox80/banners/6825_1_Boss_W_Tris.jpg?634485886601286852#width=473&height=660"
            alt=""
          />
          <br />
        ...
        <div className="watchBanner">
          <img
            src="https://www.yoox.com/images/yoox80/banners/6825_6_Montblanc_W_Tris.jpg?634485886601286852#width=473&height=660"
            alt=""
          />
          <br />
      ...
      <div className="hugBanner">
        <img
          src="https://www.yoox.com/images/yoox80/banners/6824_1_XmasGift_WM_Bottom.jpg?634485886601286852#width=1380&height=637"
          alt=""
        />
      </div>
    </>
